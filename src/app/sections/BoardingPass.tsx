...
import { Checkbox, CheckboxGroup, InputField, SelectField } from "@/components/ui";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
              ...
              <details className="mx-auto w-full max-w-3xl">
                ...
                <div className="mt-3 rounded-2xl bg-white/80 backdrop-blur-sm p-4 text-xs sm:text-sm text-gray-700 shadow-sm">
                  <p className="text-center">
                    If for some reason you are unable to register, please use this{" "}
                    <a className="underline" href="https://forms.gle/RqDamb1tQnbE3FsZ7">
                      link
                    </a>{" "}
                    instead.
                  </p>
