...
const GsapRouteCleanupContext = createContext<GsapRouteCleanupContextValue | null>(null);
...
export function GsapRouteCleanupProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <GsapRouteCleanupContext.Provider value={{ killBeforeNavigate, registerKill }}>
      {children}
